...
<html>
    ...
    <body>
        <div class="centrato">
            ...
            <h1 class="title"> <spring:message code="lista_pagamenti.title"/> </h1>
            <table class="elenco">
                ...
                <c:forEach items="${listaPagamenti}" var="item">
                    <tr>
                        ...
                        <td> <a href="lista_pagamenti/delete?id=${item.id}" > <spring:message code="operazioni.cancella"/></a> </td>
                     </tr>
                </c:forEach>
            </table>
